    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="space-y-4">
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Color Chart.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Color Chart, accessible from <a href="https://pantonecolors.net" rel="external nofollow noopener" target="_blank">https://pantonecolors.net</a></p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: info@pantonecolors.net</li>
        </ul>
      </div>
      );
};
