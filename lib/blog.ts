...
const blogPosts: BlogPost[] = [
  {
    ...
    "translations": {
      "es": {
        ...
        "excerpt": "Los colores juegan un papel crucial en la forma en que percibimos e interactuamos con los diseños. En este artículo, exploramos los impactos psicológicos de los diferentes colores y cómo usarlos de manera efectiva en sus proyectos.",
        "content": "\n      <p>Los colores tienen un profundo impacto en nuestras emociones y comportamientos. En el mundo del diseño, comprender la psicología del color es crucial para crear experiencias efectivas y atractivas. Exploremos algunos aspectos clave de la psicología del color en el diseño:</p><h2> Asociaciones emocionales</h2><p> Los distintos colores evocan distintas emociones y asociaciones. Por ejemplo:</p><ul><li> <strong>Rojo</strong> : Emoción, pasión, urgencia.</li><li> <strong>Azul</strong> : Confianza, calma, estabilidad.</li><li> <strong>Verde</strong> : Naturaleza, crecimiento, armonía.</li><li> <strong>Amarillo</strong> : felicidad, optimismo, energía.</li><li> <strong>Púrpura</strong> : lujo, creatividad, misterio.</li></ul><h2> Consideraciones culturales</h2><p> Es importante tener en cuenta que las asociaciones de colores pueden variar según la cultura. Lo que puede ser positivo en una cultura puede ser negativo en otra. Siempre investigue el contexto cultural de su público objetivo al elegir colores para diseños globales.</p><h2> Aplicaciones prácticas</h2><p> Comprender la psicología del color puede ayudar en varios escenarios de diseño:</p><ul><li> <strong>Marca</strong> : Elija colores que se alineen con la personalidad y los valores de su marca.</li><li> <strong>Diseño de interfaz de usuario</strong> : utilice colores para guiar la atención y las acciones de los usuarios.</li><li> <strong>Marketing</strong> : seleccione colores que resuenen con su público objetivo y los objetivos de su campaña.</li></ul><p> Al aprovechar el poder de la psicología del color, los diseñadores pueden crear diseños más impactantes y efectivos que resuenan con su audiencia en un nivel más profundo.</p>\n    "
      },
      "fr": {
