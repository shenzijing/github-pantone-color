...
export const translations: Translations = {
  ...
  es: {
    home: "Inicio",
    blog: "Blog",
    blogTitle: "Blog sobre información de colores",
    search: "Buscar",
  ...
  fr: {
    home: "Accueil",
    blog: "Blog",
    blogTitle: "Blog sur les couleurs",
    search: "Rechercher",
  ...
  de: {
    home: "Startseite",
    blog: "Blog",
    blogTitle: "Blog zu Farbeinblicken",
    search: "Suchen",
  ...
  it: {
    home: "Home",
    blog: "Blog",
    blogTitle: "Blog sulle intuizioni sui colori",
    search: "Cerca",
